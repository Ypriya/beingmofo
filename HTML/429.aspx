...
<script runat="server">
    ...
    Protected Sub Button1429_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim selectedValue As String = rblist1429.SelectedValue
...
<div class="container main-container headerOffset">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapsePrice" class="panel-collapse collapse in">
                        <div class="panel-body priceFilterBody">
                            <!-- -->
                            <<asp:RadioButtonList ID="rblist1429" runat="server">
    ...
    <asp:ListItem Text ="449" Value="3" />
                            ...
                            <asp:Button ID="Button1429" runat="server" Text="Check" CssClass="btn btn-default" 
                                onclick="Button1429_Click" />
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row  categoryProduct xsResponse clearfix">
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">BATMAN VS. SUPERMAN </a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">BRUCELEE </a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">TRAINING TO BEAT GOKU</a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">CLASH OF CLANS</a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">MOJO JOJO</a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">STARK TONY</a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">VALAR CANNABIS</a></h4>
