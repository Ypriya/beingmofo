...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Session("extrafries") = True
        Dim QUANT As Integer = QTY.SelectedValue * 449
        
        Dim pricecart As Integer
        pricecart = QUANT + Session.Item("cart")
        Session.Item("extrafries") = pricecart
        CART.Text = "Cart Rs. " + pricecart.ToString
        Session("extrafriesqty") = QTY.SelectedValue.ToString
        Session("extrafriessize") = SIZE.SelectedValue.ToString
        Session("extrafriesprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="etra fries" href="images/product/subcategory/7.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/7.png"
                        src='images/product/subcategory/7.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> Exercise ? Extra Fries ?</h1>

            <h3 class="product-code">Product Code : MFT007</h3>
            ...
            <div class="product-price">
                <span class="price-sales"> Rs. 449</span>
                <span class="price-standard">Rs. 549</span>
            </div>

            <div class="details-description">
                <p>Bad days are best forgotten over french fries !<br />

Get this tee and show your immense love for fries... Excercise can wait !<br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: ALWAYS</h3>
