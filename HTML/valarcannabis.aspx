...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("vcqty") = QTY.SelectedValue.ToString
        Session("vcsize") = SIZE.SelectedValue.ToString
        Session("vcprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="valar cannabis" href="images/product/subcategory/21.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/21.png"
                        src='images/product/subcategory/21.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> VALAR CANNABIS - ALL MEN MUST BAKE </h1>

            <h3 class="product-code">Product Code : MFT021</h3>
            ...
            <div class="details-description">
                <p>  When you smoke the herb, it reveals you to yourself !<br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: VALAR CANNABIS</h3>
