...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("alwaysqty") = QTY.SelectedValue.ToString
        Session("alwayssize") = SIZE.SelectedValue.ToString
        Session("alwaysprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="always" href="images/product/subcategory/1.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/1.png"
                        src='images/product/subcategory/1.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div><div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h2 class="product-title"> ALWAYS !!</h2>

            <h3 class="product-code">Product Code : MFT001</h3>
