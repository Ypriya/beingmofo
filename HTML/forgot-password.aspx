...
<script runat="server">
    ...
    Protected Sub sendmail_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            Dim pas As String = txtEmail.Text.ToLower.Trim
            Dim sqlquery As String = "select UserPassword from users where UserEmail= '" + pas + "';"
            'SELECT UserID FROM `users` WHERE `UserEmail`='priyavaity5@gmail.com'
            Dim command As System.Data.Odbc.OdbcCommand = New System.Data.Odbc.OdbcCommand(sqlquery, connectionstring)
            ...
            If reader IsNot Nothing Then
                ...
                lblmessage.Text = "password is" + password.ToString
            End If
        ...
        Try
            ...
            If Not String.IsNullOrEmpty(password) Then
                Dim mm As New System.Net.Mail.MailMessage("sender@gmail.com", txtEmail.Text.Trim)
            ...
            <div class="row userInfo">
                <div class="col-xs-12 col-sm-12">
                    ...
                    <div class="clear clearfix">
                        <ul class="pager">
                            <li>
                            <asp:Button id="sendmail" runat="server" Text="Retrieve Password" 
                                    CssClass="btn-primary" onclick="sendmail_Click"  />
