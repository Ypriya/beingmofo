...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("idncqty") = QTY.SelectedValue.ToString
        Session("idncsize") = SIZE.SelectedValue.ToString
        Session("idncprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="I DONUT CARE" href="images/product/subcategory/12.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/12.png"
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> I DoNut Care!!</h1>

            <h3 class="product-code">Product Code : MFT012</h3>
            ...
            <div class="details-description">
                <p>Eating a donut is the easiest way to tell the world thay you DONUT give a F**k.<br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: I DONUT care</h3>
