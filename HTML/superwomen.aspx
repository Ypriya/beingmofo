...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("superwomenqty") = QTY.SelectedValue.ToString
        Session("superwomensize") = SIZE.SelectedValue.ToString
        Session("superwomenprice") = QUANT
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <div class="search-box pull-right hidden-lg hidden-md hidden-sm">
               <div>
                    <asp:button ID="CART1" runat="server" Text="Cart Rs. 00" CssClass="fa fa-shopping-cart colorBlack cartRespons colorBlack" PostBackUrl="cart.aspx" BorderColor="#CC0000" ForeColor="Black"></asp:button>
                   </div>
                <!-- /input-group -->
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="Superwomen" href="images/product/subcategory/13.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/13.png"
                        src='images/product/subcategory/13.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title">  The SUperwoman !</h1>

            <h3 class="product-code">Product Code : MFT013</h3>
            ...
            <div class="product-price">
                ...
                <span class="price-standard">Rs.495</span>
            </div>

            <div class="details-description">
                <p> Don't underestimate the seductive power of a decent vocabulary. <br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: SUPERWOMEN</h3>
