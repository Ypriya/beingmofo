...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("pulpqty") = QTY.SelectedValue.ToString
        Session("pulpsize") = SIZE.SelectedValue.ToString
        Session("pulpprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="Pulp Fiction ~ BadAss MOFOs" href="images/product/subcategory/18.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/18.png"
                        src='images/product/subcategory/18.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> Pulp Fiction ~ BadAss MOFOs</h1>

            <h3 class="product-code">Product Code : MFT018</h3>
            ...
            <div class="details-description">
                <p>"And you will know my name is the Lord when I lay my vengeance upon thee." ~ Jules Winnfield<br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: pulp fiction</h3>
