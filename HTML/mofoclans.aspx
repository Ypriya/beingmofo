...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("mofoclansqty") = QTY.SelectedValue.ToString
        Session("mofoclanssize") = SIZE.SelectedValue.ToString
        Session("mofoclansprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="mofoclans" href="images/product/subcategory/15.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/15.png"
                        src='images/product/subcategory/15.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> CoC - Mofo Clan</h1>

            <h3 class="product-code">Product Code : MFT015</h3>
            ...
            <div class="product-price">
                ...
                <span class="price-standard">RS. 449</span>
            </div>

            <div class="details-description">
                <p> History will be written by men who ride hogs !<br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: CLASH OF CLANS</h3>
