...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("psleeperqty") = QTY.SelectedValue.ToString
        Session("psleepersize") = SIZE.SelectedValue.ToString
        Session("psleeperprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="PROFESSINAL SLEEPER href="images/product/subcategory/17.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/17.png"
                        src='images/product/subcategory/17.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> PROFESSINAL SLEEPER</h1>

            <h3 class="product-code">Product Code : MFT017</h3>
            ...
            <div class="details-description">
                <p>My Only relief in this life is sleeping...because when I'm sleeping, I'm not sad, angry or lonely. I'm nothing !<br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: professional sleeper</h3>
