...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("jcqty") = QTY.SelectedValue.ToString
        Session("jcsize") = SIZE.SelectedValue.ToString
        Session("jcprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="Johny Cash" href="images/product/subcategory/14.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/subcategory/14.png"
                        src='images/product/subcategory/14.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> Ain't No Grave - JC</h1>

            <h3 class="product-code">Product Code : MFT014</h3>
            ...
            <div class="product-price">
                ...
                <span class="price-standard">Rs. 595</span>
            </div>

            <div class="details-description">
                <p> Sometimes I'm two people. <br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: JOHNY CASH</h3>
