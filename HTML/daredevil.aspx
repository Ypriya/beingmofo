...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("daredevilqty") = QTY.SelectedValue.ToString
        Session("daredevilsize") = SIZE.SelectedValue.ToString
        Session("daredevilprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="DaredEvil" href="images/product/subcategory/4.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/4.png"
                        src='images/product/subcategory/4.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> DD ~ The man without fear</h1>

            <h3 class="product-code">Product Code : MFT004</h3>
            ...
            <div class="details-description">
                <p> I'm not seeking penance for what I've done father.<br />
