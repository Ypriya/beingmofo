...
<script runat="server">
   ...
   Public Sub Button1det_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Session.Clear()
        Session.RemoveAll()
        Session.Abandon()
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("entourageqty") = QTY.SelectedValue.ToString
        Session("entouragesize") = SIZE.SelectedValue.ToString
        Session("entourageprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="entourage" href="images/product/subcategory/6.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/6.png"
                        src='images/product/subcategory/6.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> I'm with my ENTOURAGE !</h1>

            <h3 class="product-code">Product Code : MFT006</h3>
            ...
            <div class="details-description">
                <p>Life changes, Friends don't !<br />
...
<script>
    Rs. (document).ready(function () {
        ...
        Rs. ('#zoomContent').zoom();
        Rs. (".zoomThumb a").click(function () {
            var largeImage = Rs. (this).find("img").attr('data-large');
            Rs. (".zoomImage1").attr('src', largeImage);
            Rs. (".zoomImg").attr('src', largeImage);
            Rs. (".gall-item").attr('href', largeImage);

        });


        Rs. ('.gall-item').magnificPopup({
            type: 'image',
            gallery: {
                enabled: true
            }
        ...
        Rs. ("#zoomContent").click(function () {
            //alert();
            Rs. ('.gall-item').trigger('click');
        });

        // CHANGE IMAGE MODAL THUMB

        Rs. (".product-thumbList a").click(function () {
            var largeImage = Rs. (this).find("img").attr('data-large');
            Rs. (".mainImg").attr('src', largeImage);
...
<script>
    Rs. (function () {
        ...
        Rs. ('.rating-tooltip-manual').rating({
            extendSymbol: function () {
                ...
                Rs. (this).on('rating.rateenter', function (e, rate) {
                    title = rate;
                    Rs. (this).tooltip('show');
                })
                        .on('rating.rateleave', function () {
                            Rs. (this).tooltip('hide');
                        });
            }
        });
