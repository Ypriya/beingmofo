...
<script runat="server">
    ...
    Protected Sub Button1399_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim selectedValue As String = rblist1399.SelectedValue
...
<div class="container main-container headerOffset">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapsePrice" class="panel-collapse collapse in">
                        <div class="panel-body priceFilterBody">
                            <!-- -->
                             <asp:RadioButtonList ID="rblist1399" runat="server">
    ...
    <asp:ListItem Text ="449" Value="3" />
                            ...
                            <asp:Button ID="Button1399" runat="server" Text="Check" CssClass="btn btn-default" 
                                onclick="Button1399_Click" />
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="row  categoryProduct xsResponse clearfix">
                    ...
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" 
                                    style="font-weight: bold; font-size: large; color: #FFFFFF">ALWAYS</a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">DEAR WOMEN</a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">ENTOURAGE</a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">TOXIC </a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">I DONUT CARE</a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">VOCABULARY </a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">PROFESSINAL SLEEPER</a></h4>
                ...
                <div class="item col-sm-4 col-lg-4 col-md-4 col-xs-6">
                    <div class="product">
                        ...
                        <div class="description">
                            <h4><a href="product-details.html" style="font-weight: bold; font-size: large; color: #FFFFFF">U R NOT BEAUTIFUL</a></h4>
