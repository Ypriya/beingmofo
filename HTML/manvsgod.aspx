...
<script runat="server">
    ...
    Protected Sub Button1det_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Session.Clear()
        Session.RemoveAll()
        Session.Abandon()
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("manvsgodqty") = QTY.SelectedValue.ToString
        Session("manvsgodsize") = SIZE.SelectedValue.ToString
        Session("manvsgodprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="MAN VS. GOD" href="images/product/subcategory/2.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/2.png"
                        src='images/product/subcategory/2.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> MAN VS. GOD</h1>

            <h3 class="product-code">Product Code : MFT002</h3>
            ...
            <div class="product-price">
                <span class="price-sales"> Rs.429 </span>
                <span class="price-standard">RS. 499</span>
            </div>

            <div class="details-description">
                <p>Superman : Your worst enemy is a clown.<br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: MAN VS. GOD</h3>
