...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("urnotqty") = QTY.SelectedValue.ToString
        Session("urnotsize") = SIZE.SelectedValue.ToString
        Session("urnotprice") = QUANT
                        ...
                        <ul class="userMenu">
                            ...
                            <li>
                                <asp:Button ID="Button1det" runat="server" CssClass="btn-primary" Font-Bold="True" 
                                    Text="LOG OUT" Visible="False" PostBackUrl="~/HTML/index6.aspx" />
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="You Never Know !" href="images/product/subcategory/20.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/20.png"
                        src='images/product/subcategory/20.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> You Never Know !</h1>

            <h3 class="product-code">Product Code : MFT020</h3>
            ...
            <div class="product-price">
                ...
                <span class="price-standard">Rs. 429</span>
            </div>
        ...
        <div id="SimilarProductSlider">
            ...
            <div class="item">
                <div class="product"><a class="product-image"> <img src="images/product/subcategory/2.png" alt="img"> </a>
                    ...
                    <div class="description">
                        <h4><a href="san-remo-spaghetti">MAN VS. GOD</a></h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: YOU ARE NOT</h3>
