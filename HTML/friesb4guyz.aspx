...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("friesbeforeguyzqty") = QTY.SelectedValue.ToString
        Session("friesbeforeguyzsize") = SIZE.SelectedValue.ToString
        Session("friesbeforeguyzprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="fRIES bEFORE gUYZ" href="images/product/subcategory/8.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/8.png"
                        src='images/product/subcategory/8.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> Fries Before Guys</h1>

            <h3 class="product-code">Product Code : MFT008</h3>
            ...
            <div class="details-description">
                <p>Fries don't ask silly questions. Fries understand.<br />
