...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("dearwomenqty") = QTY.SelectedValue.ToString
        Session("dearwomensize") = SIZE.SelectedValue.ToString
        Session("dearwomenprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="dearwomen" href="images/product/subcategory/5.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/5.png"
                        src='images/product/subcategory/5.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> Dear Women !!</h1>

            <h3 class="product-code">Product Code : MFT005</h3>
            ...
            <div class="details-description">
                <p>A bitter woman says, "All men are the same!"</br>
