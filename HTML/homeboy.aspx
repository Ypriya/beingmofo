...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Session("homeboy") = True
        Dim QUANT As Integer = QTY.SelectedValue * 429
        
        Dim pricecart As Integer
        pricecart = QUANT + Session.Item("cart")
        Session.Item("cart") = pricecart
        CART.Text = "Cart Rs. " + pricecart.ToString
        Session("homeboyqty") = QTY.SelectedValue.ToString
        Session("homeboysize") = SIZE.SelectedValue.ToString
        Session("homeboyprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="My HomeBoy" href="images/product/subcategory/3.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/3.png"
                        src='images/product/subcategory/3.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> My Homeboy</h1>

            <h3 class="product-code">Product Code : MFT003</h3>
            ...
            <div class="product-price">
                <span class="price-sales"> $429</span>
                <span class="price-standard">$529</span>
            </div>

            <div class="details-description">
                <p> "A fight is not won bye one puch or kick.<br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: HOMEBOY</h3>
