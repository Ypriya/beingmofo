...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("starkqty") = QTY.SelectedValue.ToString
        Session("starksize") = SIZE.SelectedValue.ToString
        Session("starkprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="TONY STARK" href="images/product/subcategory/19.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/19.png"
                        src='images/product/subcategory/19.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> It's hard to be a STARK </h1>

            <h3 class="product-code">Product Code : MFT019</h3>
            ...
            <div class="details-description">
                <p> A STARK can be brave when he's not home !<br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: STARK TONY</h3>
