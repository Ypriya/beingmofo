...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("ekvillianqty") = QTY.SelectedValue.ToString
        Session("ekvilliansize") = SIZE.SelectedValue.ToString
        Session("ekvillianprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="Ek Villian" href="images/product/subcategory/16.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/16.png"
                        src='images/product/subcategory/16.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> Ek Villian</h1>

            <h3 class="product-code">Product Code : MFT016</h3>
            ...
            <div class="details-description">
                <p> "My intellect is everything...Defeat is absurd." ~ Mojo Jojo <br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: ek villian</h3>
