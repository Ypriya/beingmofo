...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("gokuqty") = QTY.SelectedValue.ToString
        Session("gokusize") = SIZE.SelectedValue.ToString
        Session("gokuprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="GOKU" href="images/product/subcategory/9.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/9.png"
                        src='images/product/subcategory/9.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> Training To Beat GOKU</h1>

            <h3 class="product-code">Product Code : MFT009</h3>
            ...
            <div class="product-price">
                ...
                <span class="price-standard">Rs.529</span>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: TRAINING TO BEAT GOKU</h3>
