...
<script runat="server">
    ...
    Public Sub addtocart_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Session("toxicqty") = QTY.SelectedValue.ToString
        Session("toxicsize") = SIZE.SelectedValue.ToString
        Session("toxicprice") = QUANT
    ...
    <div class="row transitionfx">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 productImageZoom">
            ...
            <div class='zoom' id='zoomContent'>
                <a class="gall-item" title="TOXIC" href="images/product/subcategory/10.png"><img
                        class="zoomImage1 img-responsive" data-src="images/product/zoom/10.png"
                        src='images/product/subcategory/10.png' alt='Daisy on the Ohoopee'/></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-5">
            ...
            <h1 class="product-title"> Toxic</h1>

            <h3 class="product-code">Product Code : MFT010</h3>
            ...
            <div class="details-description">
                <p> Atheism is not a disbelief in gods or denial of gods; it is a lack of belief in gods.<br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 class="reviewtitle uppercase">You're reviewing: TOXIC</h3>
